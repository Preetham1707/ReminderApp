...
function App() {
  ...
  useEffect(function () {
    async function fetchData() {
      ...
      try {
        const response = await fetch(`http://${process.env.SERVICE_SERVICE_BACKEND_HOST}/goals`);
  ...
  async function deleteGoalHandler(goalId) {
    ...
    try {
       const response = await fetch(`http://${process.env.SERVICE_SERVICE_BACKEND_HOST}/goals` + goalId, {
