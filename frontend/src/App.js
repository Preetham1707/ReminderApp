...
function App() {
  ...
  useEffect(function () {
    async function fetchData() {
      ...
      try {
        const response = await fetch(`http://${process.env.SERVICE_BACKEND_SERVICE_HOST}/goals`);
  ...
  async function deleteGoalHandler(goalId) {
    ...
    try {
       const response = await fetch(`http://${process.env.SERVICE_BACKEND_SERVICE_HOST}/goals` + goalId, {
